...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_logged_in_with_permission_borrowed_book(self):
        ...
        resp = self.client.get(reverse('catalog:renew-book-librarian', kwargs={'pk':self.test_bookinstance2.pk,}) )
    ...
    #     resp = self.client.post(reverse('catalog:renew-book-librarian', kwargs={'pk':self.test_bookinstance1.pk,}), {'renewal_date':valid_date_in_future},follow=True )
...
class AuthorCreateViewTest(TestCase):
    ...
    #     self.assertEqual( resp.status_code,200)
    #
    #     expected_initial_date = datetime.date(2018, 4, 24)
    ...
    def test_redirects_to_detail_view_on_success(self):
        login = self.client.login(username='testuser2', password='12345')
        resp = self.client.post(reverse('catalog:author_create'),{'first_name':'Christian Name','last_name':'Surname',} )
